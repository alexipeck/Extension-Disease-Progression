    ...
    public static class SiteVars
    {
        ...
        public static void SerializeAsBincode(string outputPath, int timestep, List<(int x, int y)> healthySitesList, List<(int x, int y)> infectedSitesList, List<(int x, int y)> ignoredSitesList) {
            ...
            using (BinaryWriter writer = new BinaryWriter(fs))
            {
                ...
                writer.Write((uint)width);
                writer.Write((uint)height);
                ulong healthyCount = (ulong)healthySitesList.Count;
                writer.Write(healthyCount);
                ...
                ulong infectedCount = (ulong)infectedSitesList.Count;
                writer.Write(infectedCount);
                ...
                ulong ignoredCount = (ulong)ignoredSitesList.Count;
                writer.Write(ignoredCount);
